...
return [
    ...
    'events' => [
        ...
        'fields' => [
            ...
            'notes' => 'Notes',
            'free' => 'Free',
            'require-sponsorships' => 'Require Sponsorships',
            'require-snacks-sponsorship' => 'Require Snack Sponsorships',
            'require-stationary-sponsorship' => 'Require Stationary Sponsorships',
            'require-facial-sponsorship' => 'Require Facial Sponsorships',
            'require-cash-sponsorship' => 'Require Cash Sponsorships',
            'require-shirt-vendor' => 'Require Shirt Vendor',
            'require-food-vendor' => 'Require Food Vendor',
            'require-games-vendor' => 'Require Games Vendor',
            'sponsor-fulfillment-display-poster' => 'Sponsor Fulfillment Display Poster',
            'sponsor-fulfillment-display-standees' => 'Sponsor Fulfillment Display Standees',
            'sponsor-fulfillment-display-tv' => 'Sponsor Fulfillment Display TV',
            'sponsor-fulfillment-fb-likeandshare' => 'Sponsor Fulfillment Facebook Like & Share',
            'sponsor-fulfillment-fb-review' => 'Sponsor Fulfillment Facebook Review',
            'sponsor-fulfillment-ig' => 'Sponsor Fulfillment Instagram',
            'sponsor-fulfillment-google' => 'Sponsor Fulfillment Google',
            'sponsor-fulfillment-afu' => 'Sponsor Fulfillment AllForU',
            'sponsor-fulfillment-booth' => 'Sponsor Fulfillment Booth',
            'club' => 'Hosting Club',
            'images' => 'Images',
        ],
    ],
