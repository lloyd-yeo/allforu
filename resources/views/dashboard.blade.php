    ...
    {{--<section id="content">--}}
        ...
        {{--<div class="content-wrap">--}}
            ...
            {{--<div class="container clearfix">--}}
                ...
                {{--<div id="related-portfolio" class="owl-carousel portfolio-carousel carousel-widget" data-margin="30" data-nav="false" data-autoplay="5000" data-items-xxs="1" data-items-xs="2" data-items-sm="3" data-items-md="4" data-items-lg="4">--}}
                ...
                {{--<div class="col_two_third">--}}
                    ...
                    {{--<div class="col_one_third">--}}
                        ...
                        {{--<div class="widget clearfix">--}}
                            ...
                            {{--<img src="{{ asset('canvas/images/footer-widget-logo.png') }}" alt="" class="footer-logo">--}}

                            {{--<p>We believe in <strong>Simple</strong>, <strong>Creative</strong> &amp; <strong>Flexible</strong> Design Standards.</p>--}}

                            {{--<div style="background: url('{{ asset('canvas/images/world-map.png') }}') no-repeat center center; background-size: 100%;">--}}
                                {{--<address>--}}
